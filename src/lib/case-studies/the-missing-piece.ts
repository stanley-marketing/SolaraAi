...
const theMissingPieceCaseStudy: CaseStudy = {
  slug: "the-missing-piece",
  title: "The Missing Piece Case Study",
  clientName: "The Missing Piece",
  ...
  clientLogo: {
    src: "/images/case-studies/the-missing-piece-logo.webp",
  ...
  cta: {
    headline: "Ready to build your digital marketing engine?",
    link: "/contact",
  },
  seoMeta: {
...
export default theMissingPieceCaseStudy;
